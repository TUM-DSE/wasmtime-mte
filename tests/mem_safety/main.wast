(module
  ...
  (func $test (;10;) (type 2) (param i32 i32) (result i32)
    (local i32 i32)
    global.get $__stack_pointer
    i32.const 256
    i32.sub
  ...
  (func $test2 (;11;) (type 3) (param i32) (result i32)
  ...
  (func $_Exit (;17;) (type 6) (param i32)
    local.get 0
    call $__wasi_proc_exit
    unreachable
  )
  (func $__main_void (;18;) (type 8) (result i32)
    (local i32 i32 i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $__wasi_args_get (;19;) (type 2) (param i32 i32) (result i32)
    local.get 0
    local.get 1
  ...
  (func $__wasi_args_sizes_get (;20;) (type 2) (param i32 i32) (result i32)
    local.get 0
    local.get 1
  ...
  (func $__wasi_fd_close (;21;) (type 3) (param i32) (result i32)
    local.get 0
    call $__imported_wasi_snapshot_preview1_fd_close
    i32.const 65535
    i32.and
  )
  (func $__wasi_fd_fdstat_get (;22;) (type 2) (param i32 i32) (result i32)
    local.get 0
    local.get 1
  ...
  (func $__wasi_fd_seek (;23;) (type 4) (param i32 i64 i32 i32) (result i32)
    local.get 0
    local.get 1
    local.get 2
    local.get 3
  ...
  (func $__wasi_fd_write (;24;) (type 5) (param i32 i32 i32 i32) (result i32)
    local.get 0
    local.get 1
    local.get 2
    local.get 3
  ...
  (func $__wasi_proc_exit (;25;) (type 6) (param i32)
    local.get 0
    call $__imported_wasi_snapshot_preview1_proc_exit
    unreachable
  )
  (func $abort (;26;) (type 7)
    unreachable
    unreachable
  )
  (func $sbrk (;27;) (type 3) (param i32) (result i32)
    block ;; label = @1
      local.get 0
      br_if 0 (;@1;)
      memory.size
  ...
  (func $dummy (;28;) (type 7))
  (func $__wasm_call_dtors (;29;) (type 7)
    call $dummy
    call $__stdio_exit
  )
  (func $printf (;30;) (type 2) (param i32 i32) (result i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $close (;31;) (type 3) (param i32) (result i32)
    block ;; label = @1
      local.get 0
  ...
  (func $__stdio_close (;32;) (type 3) (param i32) (result i32)
    local.get 0
    i32.load offset=56
    call $close
  )
  (func $__lseek (;33;) (type 1) (param i32 i64 i32) (result i64)
    (local i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $__stdio_seek (;34;) (type 1) (param i32 i64 i32) (result i64)
    local.get 0
    i32.load offset=56
    local.get 1
    local.get 2
  ...
  (func $writev (;35;) (type 0) (param i32 i32 i32) (result i32)
    (local i32 i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $__stdio_write (;36;) (type 0) (param i32 i32 i32) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $__isatty (;37;) (type 3) (param i32) (result i32)
    (local i32 i32)
    global.get $__stack_pointer
    i32.const 32
    i32.sub
  ...
  (func $__stdout_write (;38;) (type 0) (param i32 i32 i32) (result i32)
    local.get 0
    i32.const 4
    i32.store offset=32
    block ;; label = @1
  ...
  (func $__ofl_lock (;39;) (type 8) (result i32)
    i32.const 5224
  )
  (func $__stdio_exit (;40;) (type 7)
    (local i32 i32 i32)
    block ;; label = @1
      call $__ofl_lock
      i32.load
  ...
  (func $__towrite (;41;) (type 3) (param i32) (result i32)
    (local i32)
    local.get 0
    local.get 0
    i32.load offset=60
  ...
  (func $__fwritex (;42;) (type 0) (param i32 i32 i32) (result i32)
    (local i32 i32 i32 i32 i32)
    block ;; label = @1
      block ;; label = @2
        local.get 2
  ...
  (func $fwrite (;43;) (type 5) (param i32 i32 i32 i32) (result i32)
  ...
  (func $strerror (;44;) (type 3) (param i32) (result i32)
    (local i32)
    block ;; label = @1
      i32.const 0
  ...
  (func $fputs (;45;) (type 2) (param i32 i32) (result i32)
    (local i32)
    local.get 0
    call $strlen
    local.set 2
  ...
  (func $vfprintf (;46;) (type 0) (param i32 i32 i32) (result i32)
    (local i32 i32 i32)
    global.get $__stack_pointer
    i32.const 208
    i32.sub
  ...
  (func $printf_core (;47;) (type 9) (param i32 i32 i32 i32 i32) (result i32)
  ...
  (func $pop_arg (;48;) (type 10) (param i32 i32 i32)
    block ;; label = @1
      block ;; label = @2
        block ;; label = @3
          block ;; label = @4
  ...
  (func $pad (;49;) (type 11) (param i32 i32 i32 i32 i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 256
    i32.sub
  ...
  (func $long_double_not_supported (;50;) (type 7)
    i32.const 1104
    i32.const 3560
    call $fputs
    drop
  ...
  (func $memcpy (;51;) (type 0) (param i32 i32 i32) (result i32)
  ...
  (func $memset (;52;) (type 0) (param i32 i32 i32) (result i32)
  ...
  (func $strlen (;53;) (type 3) (param i32) (result i32)
    (local i32 i32)
    local.get 0
    local.set 1
    block ;; label = @1
  ...
  (func $memchr (;54;) (type 0) (param i32 i32 i32) (result i32)
    (local i32 i32 i32)
    local.get 2
    i32.const 0
    i32.ne
  ...
  (func $strnlen (;55;) (type 2) (param i32 i32) (result i32)
    (local i32)
    local.get 0
    i32.const 0
    local.get 1
  ...
  (func $#func56<dummy> (@name "dummy") (;56;) (type 2) (param i32 i32) (result i32)
    local.get 0
  )
  (func $__lctrans (;57;) (type 2) (param i32 i32) (result i32)
    local.get 0
    local.get 1
    call $#func56<dummy>
  )
  (func $wcrtomb (;58;) (type 0) (param i32 i32 i32) (result i32)
    (local i32)
    i32.const 1
    local.set 3
    block ;; label = @1
  ...
  (func $wctomb (;59;) (type 2) (param i32 i32) (result i32)
    block ;; label = @1
      local.get 0
      br_if 0 (;@1;)
      i32.const 0
  ...
  (func $frexp (;60;) (type 12) (param f64 i32) (result f64)
    (local i64 i32)
    block ;; label = @1
      local.get 0
      i64.reinterpret_f64
